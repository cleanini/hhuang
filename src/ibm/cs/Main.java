...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		if (runLoc == 1) {
			...
			String multiT = "s";
			int testbasicOps = 0;
			String uuidpath = "/Users/hhuang/Documents/suspUUID.txt";
			/*
			if (testbasicOps == 0)				
				analyzer.startFromAvroFile("/Users/hhuang/Documents/avro_demo/avro_demo/dataCDM/basic-ops.cdm", multiT, uuidpath, dump);
			else if (testbasicOps == 1)
				analyzer.startFromAvroFile("/Users/hhuang/Documents/avro_demo/avro_demo/dataCDM/boot-and-gather.cdm",
						multiT, uuidpath, dump);
			else if (testbasicOps == 2) {
				analyzer.startFromAvroFile(
						"/Users/hhuang/Downloads/2017-04-20/gather-project/boot-and-gatherproject.cdm", multiT, uuidpath, dump); // native				
			} else if (testbasicOps == 3) {// AdumpAPT
				analyzer.startFromAvroFile("/Users/hhuang/Downloads/prov-output.cdm", multiT, uuidpath, dump);				
			} else if (testbasicOps == 4) { 
				analyzer.startFromAvroFile("/Volumes/seagate8t/DP-TC/ta1-clearscope-cdm17.bin", multiT, uuidpath, dump);
				analyzer.startFromAvroFile("/Volumes/seagate8t/DP-TC/ta1-clearscope-cdm17.bin.1", multiT, uuidpath, dump);
				analyzer.startFromAvroFile("/Volumes/seagate8t/DP-TC/ta1-clearscope-cdm17.bin.2", multiT, uuidpath, dump);
				analyzer.startFromAvroFile("/Volumes/seagate8t/DP-TC/ta1-clearscope-cdm17.bin.3", multiT, uuidpath, dump);
				analyzer.startFromAvroFile("/Volumes/seagate8t/DP-TC/ta1-clearscope-cdm17.bin.4", multiT, uuidpath, dump);
				...
				analyzer.startFromAvroFile("/Users/hhuang/Downloads/ta1-clearscope-pandex-cdm17.bin.5", multiT, uuidpath, dump);
