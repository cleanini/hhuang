...
public class ProcessDatum18 implements Runnable {
	private Thread t;
	...
	ProcessDatum18(CountDownLatch lt, String name, ArrayList<Object> datumList, Map<String, Integer> typecnt) throws InterruptedException {
	      threadName = name;	      
